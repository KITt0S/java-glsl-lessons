...
public class Field implements GLEventListener {
    ...
    private void setShaderData( GL2 gl ) {
        ...
        FloatBuffer vertexes = model.getAllVertexesBuffer();
        FloatBuffer normals = model.getAllNormalsBuffer();
        ...
        gl.glUniform4f( ShaderUtils.getUniLoc( gl, program, "LightPosition" ), 100f, 20f, 100f, 1f );
        gl.glUniform3f( ShaderUtils.getUniLoc( gl, program, "LightIntensity" ), 1f, 1f, 1f );
        ...
        gl.glUniform1f( ShaderUtils.getUniLoc( gl, program, "Shininess" ), 50f );
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glDrawArrays( GL2.GL_TRIANGLES, 0, pSize );
    }

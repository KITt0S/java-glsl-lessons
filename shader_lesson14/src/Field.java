...
public class Field implements GLEventListener {
    ...
    private void setShaderData( GL2 gl ) {
        ...
        gl.glUniform1f( ShaderUtils.getUniLoc( gl, program, "Fog.minDist" ), 0f );
        gl.glUniform1f( ShaderUtils.getUniLoc( gl, program, "Fog.maxDist" ), 20f );
        gl.glUniform3f( ShaderUtils.getUniLoc( gl, program, "Fog.color" ), 0.5f, 0.5f, 0.5f );
